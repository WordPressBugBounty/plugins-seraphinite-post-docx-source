...
class Ui
{
	...
	static function PostBoxes( $title, $metaBoxes = array( 'body' => null ), array $callbacks = null, $callbacks_args = null, $blocksAttrs = null )
	{
		...
		echo( wp_kses( Ui::ViewInitContent( '.wrap.seraph_pds' ), Wp::GetKsesSanitizeCtx( 'script' ) ) );
	}
...
class UiPopups
{
	...
	static function Draw()
	{
		...
		if( $needModal )
			echo( wp_kses( Ui::Tag( 'div', null, array( 'class' => 'seraph_pds popup_modal_overlay', 'style' => array( 'display' => 'none' ) ) ), Wp::GetKsesSanitizeCtx( 'admin' ) ) );
	}
}
